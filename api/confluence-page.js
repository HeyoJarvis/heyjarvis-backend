...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Call Confluence API
    // Note: Confluence API v2 uses 'body' not 'body.storage'
    const response = await fetch(
      `https://api.atlassian.com/ex/confluence/${jiraSettings.cloud_id}/wiki/api/v2/pages/${pageId}?body-format=storage`,
      {
        headers: {
    ...
    // Return structure compatible with desktop app
